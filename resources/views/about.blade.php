      ...
      <div class="row">
        <div class="col-lg-7 mx-auto align-self-center">
          <div class=" text-center">
            <h1>About Us</h1>
            <p>NaturesGarde is a global drug dealing company with one of the most highest reputation.</p>ˀ
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 col-lg-4 d-lg-flex mb-4 mb-lg-0 pl-4" data-aos="fade-up" data-aos-delay="">
          ...
          <div class="text">
            <h2>Free Shipping</h2>
            <p>One of our company's offer is free shipping for no additional costs.</p>
          </div>
        </div>
        <div class="col-md-6 col-lg-4 d-lg-flex mb-4 mb-lg-0 pl-4" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="text">
            <h2>Free Returns</h2>
            <p>Goods bought in bad condition can be returned within 20 days</p>
          </div>
        </div>
        <div class="col-md-6 col-lg-4 d-lg-flex mb-4 mb-lg-0 pl-4" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="text">
            ...
            <p>We have caring customer support in our company for our loyal consumers.</p>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="block-38 text-center">
            <div class="block-38-img">
              <div class="block-38-header">
                ...
                <h3 class="block-38-heading h4">Amiolemen Blessing</h3>
                <p class="block-38-subheading">Retailer</p>
              </div>
              <div class="block-38-body">
                <p>Amiolemen Blessing intends to make it easy for consumers to buy their goods. </p>
              </div>
            </div>
          </div>
        </div>
