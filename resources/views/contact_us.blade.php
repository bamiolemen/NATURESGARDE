      ...
      <div class="row">
        ...
        <div class="col-lg-4">
          <div class="p-4 bg-white mb-3 rounded">
            <span class="d-block text-black h6 text-uppercase">Lagos</span>
            <p class="mb-0">Ikeja, Lagos, NIGERIA</p>
          </div>
        </div>
        <div class="col-lg-4">
          <div class="p-4 bg-white mb-3 rounded">
            <span class="d-block text-black h6 text-uppercase">Abuja</span>
            <p class="mb-0">Abuja, NIGERIA</p>
          </div>
        </div>
        <div class="col-lg-4">
          <div class="p-4 bg-white mb-3 rounded">
            <span class="d-block text-black h6 text-uppercase">Edo</span>
            <p class="mb-0">Benin, Edo, NIGERIA</p>
          </div>
        </div>
      </div>
    </div>
